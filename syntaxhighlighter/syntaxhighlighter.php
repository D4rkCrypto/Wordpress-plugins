...
Last edited by D4rk7r4c3r on February 6, 2017
...
class SyntaxHighlighter {
	...
	function __construct() {
		...
		wp_register_script( 'syntaxhighlighter-brush-vimscript',  plugins_url( 'third-party-brushes/shBrushVimscript.js',         __FILE__ ), array('syntaxhighlighter-core'), '20170205'     );
		...
		wp_register_style(  'syntaxhighlighter-theme-blackboard', 	   plugins_url( $this->shfolder . '/styles/shThemeBlackboard.css', 		__FILE__ ), array('syntaxhighlighter-core'), $this->agshver );
		wp_register_style(  'syntaxhighlighter-theme-rush', 	  	   plugins_url( $this->shfolder . '/styles/shThemeRush.css',       		__FILE__ ), array('syntaxhighlighter-core'), $this->agshver );
		wp_register_style(  'syntaxhighlighter-theme-solarized-dark',  plugins_url( $this->shfolder . '/styles/shThemeSolarized-dark.css',  __FILE__ ), array('syntaxhighlighter-core'), $this->agshver );
		wp_register_style(  'syntaxhighlighter-theme-solarized-light', plugins_url( $this->shfolder . '/styles/shThemeSolarized-light.css', __FILE__ ), array('syntaxhighlighter-core'), $this->agshver );
		wp_register_style(  'syntaxhighlighter-theme-spacegrey', 	   plugins_url( $this->shfolder . '/styles/shThemeSpacegrey.css', 		__FILE__ ), array('syntaxhighlighter-core'), $this->agshver );
		wp_register_style(  'syntaxhighlighter-theme-spacegrey-light', plugins_url( $this->shfolder . '/styles/shThemeSpacegrey-light.css', __FILE__ ), array('syntaxhighlighter-core'), $this->agshver );
		wp_register_style(  'syntaxhighlighter-theme-tomorrow', 	   plugins_url( $this->shfolder . '/styles/shThemeTomorrow.css',		__FILE__ ), array('syntaxhighlighter-core'), $this->agshver );
		wp_register_style(  'syntaxhighlighter-theme-tomorrow-light',  plugins_url( $this->shfolder . '/styles/shThemeTomorrow-light.css',  __FILE__ ), array('syntaxhighlighter-core'), $this->agshver );
		...
		$this->themes = (array) apply_filters( 'syntaxhighlighter_themes', array(
			...
			'blackboard'      => __( 'Blackboard',   	'syntaxhighlighter' ),
			'rush'		 	  => __( 'Rush',			'syntaxhighlighter' ),
			'solarized-dark'  => __( 'Solarized-dark',	'syntaxhighlighter' ),
			'solarized-light' => __( 'Solarized-light',	'syntaxhighlighter' ),
			'spacegrey'		  => __( 'Spacegrey',		'syntaxhighlighter' ),
			'spacegrey-light' => __( 'Spacegrey-light',	'syntaxhighlighter' ),
			'tomorrow'		  => __( 'Tomorrow',		'syntaxhighlighter' ),
			'tomorrow-light'  => __( 'Tomorrow-light',	'syntaxhighlighter' ),
		) );
